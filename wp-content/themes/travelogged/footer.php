    ...
    <div class="footer_inner">
        ...
        <div class="coppy-right">
            <div class="container ">
                <div class="row">
                    <div class="col">
                        <p><?php echo esc_attr( get_theme_mod( 'copyright','Developed & designed by' ) ); ?> <a href="<?php echo esc_url( get_theme_mod( 'copyright_link','https://weblizar.com/' ) ); ?>"> <?php echo esc_attr( get_theme_mod( 'copyright_link_t','weblizar' ) ); ?> </a></p>
                    </div>
                </div>
            </div>
        </div>
