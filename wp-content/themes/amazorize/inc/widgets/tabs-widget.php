...
/*
|
|	Plugin Name: Amazorize Taps Widget
|	Description: A widget to display taps widget.
|	Version: 1.0
|
*/

function amazorize_latest_tabs( $posts = 5 ) {
	...
	<div class="left-widget">
		<?php if( has_post_thumbnail() ): ?>
			...
			<a href="<?php the_permalink(); ?>">
				<?php the_post_thumbnail('amazorize-widget', array('title' => '')); ?>
			</a>
...
function amazorize_popular_tabs( $posts = 5 ) {
...
class amazorize_Widget_Tabs extends WP_Widget {

	function __construct() {
		$widget_ops = array('classname' => 'widget_tab', 'description' => __( 'Your most recent posts & popular posts.', 'amazorize' ) );
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('tab', __('Amazorize Tab Posts', 'amazorize'), $widget_ops, $control_ops);
	}
...
?>
	...
	<div id="tabwrap">
		...
		<ul class="tabs">
			<li><h3 class="widget-title"><a href="#" class="recent-post-title current-tap"><?php esc_html_e('Recent', 'amazorize'); ?></a></h3></li>
			<li><h3 class="widget-title"><a href="#" class="popular-post-title"><?php esc_html_e('Popular', 'amazorize'); ?></a></h3></li>
		</ul> <!--end .tabs-->
		...
		<div class="inside">
			...
			<div id="recent-posts" class="data-list current-data"> 
				<ul>
					<?php amazorize_latest_tabs($recent_post_num); ?>
				</ul>
			...
			<div id="popular-posts" class="data-list">
				<ul>
					<?php rewind_posts(); ?>
					<?php amazorize_popular_tabs( $popular_post_num ); ?>
				</ul>
...
<?php echo $after_widget; ?>
	...
	function form( $instance ) {
		...
		$recent_post_num = sanitize_text_field($instance['recent_post_num']);
	?>
		<p><label for="<?php echo $this->get_field_id('recent_post_num'); ?>"><?php esc_html_e('Number of latest posts to show:', 'amazorize'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('popular_post_num'); ?>"><?php esc_html_e('Number of popular posts to show:', 'amazorize'); ?></label>
...
register_widget('amazorize_Widget_Tabs');
